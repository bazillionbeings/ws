...
//BB addition
WebSocketServer.createExtensions = function(secWebsocketExtensions) {
  var offer = parseExtension(secWebsocketExtensions);
  var extensions = {};
...
WebSocketServer.Extensions = Extensions;
WebSocketServer.PerMessageDeflate = PerMessageDeflate;
